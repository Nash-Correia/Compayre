...
export default function PieChart({ data, totalAmount, size = "md", showLegend = true }: PieChartProps) {
  // Calculate angles for pie chart
  let currentAngle = 0;
  const pieData = data.map((component) => {
  ...
  return (
    <div className="flex flex-col items-center">
      {/* Pie Chart */}
      <div className={`relative ${sizes.container} mb-3`}>
